...
public class Keystrokes extends Module {
    ...
    public void drawComponent() {
        final String wKey = Keyboard.getKeyName(mc.gameSettings.keyBindForward.getKeyCode()).replace("NONE", "");
        final String sKey = Keyboard.getKeyName(mc.gameSettings.keyBindBack.getKeyCode()).replace("NONE", "");
        final String aKey = Keyboard.getKeyName(mc.gameSettings.keyBindLeft.getKeyCode()).replace("NONE", "");
        final String dKey = Keyboard.getKeyName(mc.gameSettings.keyBindRight.getKeyCode()).replace("NONE", "");

        this.drawRectangle(this.getGuiX() + 17, this.getGuiY() + 20 - keySize - gaping, keySize, keySize, InputUtils.isKeyDown(mc.gameSettings.keyBindForward.getKeyCode()), this.getBackgroundWhite());
        FontUtils.drawFont(wKey, this.getGuiX() + 22.8F, this.getGuiY() + 27 - keySize - gaping, this.getFontColor());

        this.drawRectangle(this.getGuiX() + 17, this.getGuiY() + 20, keySize, keySize, InputUtils.isKeyDown(mc.gameSettings.keyBindBack.getKeyCode()), this.getBackgroundWhite());
        FontUtils.drawFont(sKey, this.getGuiX() + 24, this.getGuiY() + 27, this.getFontColor());

        this.drawRectangle(this.getGuiX() + 17 - keySize - gaping, this.getGuiY() + 20, keySize, keySize, InputUtils.isKeyDown(mc.gameSettings.keyBindLeft.getKeyCode()), this.getBackgroundWhite());
        FontUtils.drawFont(aKey, this.getGuiX() + 24 - keySize - gaping, this.getGuiY() + 27, this.getFontColor());

        this.drawRectangle(this.getGuiX() + 17 + keySize + gaping, this.getGuiY() + 20, keySize, keySize, InputUtils.isKeyDown(mc.gameSettings.keyBindRight.getKeyCode()), this.getBackgroundWhite());
        FontUtils.drawFont(dKey, this.getGuiX() + 24 + keySize + gaping, this.getGuiY() + 27, this.getFontColor());

        if (this.spaceBar.isEnabled()) {
            if (this.mouseButtons.isEnabled()) {
                this.drawRectangle(this.getGuiX() + 17 - keySize - gaping, this.getGuiY() + 34 + keySize + gaping, keySize * 3 + (gaping * 2), keySize - 5, InputUtils.isKeyDown(mc.gameSettings.keyBindJump.getKeyCode()), this.getBackgroundWhite());
                ...
                this.drawRectangle(this.getGuiX() + 17 - keySize - gaping, this.getGuiY() + 20 + keySize + gaping, keySize * 3 + (gaping * 2), keySize - 5, InputUtils.isKeyDown(mc.gameSettings.keyBindJump.getKeyCode()), this.getBackgroundWhite());
